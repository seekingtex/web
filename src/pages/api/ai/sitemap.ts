...
export const GET: APIRoute = async ({ locals: _locals }) => {
  ...
  const pages = [
    ...
    {
      id: 'randd-fabric-engineering',
      url: '/randdcenter/fabric-engineering',
      title: 'Fabric Engineering Studio',
      section: 'randd',
      type: 'technology',
    },
    {
    ...
    {
      id: 'randd-performance-testing',
      url: '/randdcenter/performance-testing-lab',
      title: 'Textile Performance Testing Lab',
      section: 'randd',
      type: 'technology',
    },
    {
