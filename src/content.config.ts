...
const featuredProductsSection = z
  .object({
    id: z.string().optional(),
    title: z.string().optional(),
    subtitle: z.string().optional(),
  ...
  schema: createLocaleSchema({
    ...
    footer: z
      .object({
        ...
        socialLinks: z
          .array(
            z.object({ ariaLabel: z.string().optional(), icon: z.string().optional(), href: z.string().optional() })
          )
          .optional(),
